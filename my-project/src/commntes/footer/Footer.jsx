...
export default function Footer() {
    let footerText = [
        ...
        {links:["© ochi design 2024. Legal Terms"]},
    
        ]    
  return (
    <div className='flex min-h-[100vh] w-full px-[50px] py-[2vw] relative bg-[#f1f1f1]' data-scrol data-scroll-speed=".2">
        <div className="part-1 w-1/2 flex flex-col justify-between ">
        <h1 className='hea w-[30%] uppercase font-bold'>eye-opening</h1>
        <div className="logo">
        ...
        <div className="part-2 ">
            <h1 className='hea  uppercase font-bold'>presentations</h1>
            <div className='flex mt-[5vw] justify-between '>

            <div className="sub-part-1 flex flex-col ">
               {
            ...
            <div className="sub-part-2 text-[1.2vw]   flex flex-col justify-center">
                <p>M:</p>
                <p className='underline'>Home</p>
                <p className='underline'>Service</p>
                <p className='underline'>Our work</p>
                <p className='underline'>about as</p>
